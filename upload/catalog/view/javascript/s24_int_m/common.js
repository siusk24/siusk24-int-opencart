var S24_INT_M_COMMON = {
    ...
    alert: function ({ message, onClose }) {
        ...
        let dialog = document.querySelector('dialog[data-siusk24intm-alert-dialog]');
        if (!dialog) {
            dialog = document.createElement('dialog');
            dialog.dataset.siusk24intmAlertDialog = true;
    ...
    confirm: function ({ message, accept, cancel }) {
        ...
        let dialog = document.querySelector('dialog[data-siusk24intm-confirm-dialog]');
        if (!dialog) {
            dialog = document.createElement('dialog');
            dialog.dataset.siusk24intmConfirmDialog = true;
            dialog.style.padding = 0;
            let dialogHtml = `
                <form method="dialog" class="panel panel-default" style="margin: 0;">
                    <div class="panel-body" data-alert-message></div>
